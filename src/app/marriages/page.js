  ...
  return (
    <div style={{ maxWidth: '1350px', margin: '0 auto', paddingBottom: '40px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          <h1 style={{ fontSize: '1.6rem', fontWeight: '800', color: '#0f172a', letterSpacing: '-0.02em', margin: 0 }}>Marriage Assistance Module</h1>
          <p style={{ color: '#64748b', fontSize: '0.85rem', marginTop: '3px', margin: 0 }}>Program dashboard & application processing</p>
        </div>
        <button 
          className="btn-primary" 
          onClick={() => router.push('/marriages/form')}
        ...
        <div style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div className="grid-responsive-5col" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            ...
            <div className="card" style={{ padding: '20px', borderRadius: '18px', background: '#fff', boxShadow: '0 2px 12px rgba(0,0,0,0.03)', border: '1px solid #e8edf2', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <span style={{ fontSize: '1.8rem', fontWeight: '800', color: '#0f172a' }}>{dashboardData.summary.total_cases}</span>
            </div>
            ...
            <div className="card" style={{ padding: '20px', borderRadius: '18px', background: '#fff', boxShadow: '0 2px 12px rgba(0,0,0,0.03)', border: '1px solid #e8edf2', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: '0.75rem', fontWeight: '800', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Settled</span>
            ...
            <div className="card" style={{ padding: '20px', borderRadius: '18px', background: '#fff', boxShadow: '0 2px 12px rgba(0,0,0,0.03)', border: '1px solid #e8edf2', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <span style={{ fontSize: '1.8rem', fontWeight: '800', color: '#0f172a' }}>{dashboardData.summary.this_month_cases}</span>
            </div>
                ...
                <table className="premium-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                  <thead>
                    <tr>
                      ...
                      <th style={{ padding: '10px 12px', fontSize: '0.72rem', fontWeight: '800', color: '#64748b', textTransform: 'uppercase' }}>Settled</th>
                  ...
                  <tbody>
                    ...
                    {dashboardData.plan_wise.length === 0 && (
              ...
              <div className="premium-table-container">
                <table className="premium-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                  ...
                  <tbody>
                    ...
                    {dashboardData.agent_wise.length === 0 && (
      ...
      <div className="card" style={{ padding: '0', overflow: 'hidden', borderRadius: '18px', background: '#fff', boxShadow: '0 2px 12px rgba(0,0,0,0.03)', border: '1px solid #e8edf2' }}>
              ...
              {['All', 'Upcoming', 'Settled', 'Deleted'].map(t => (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: '700',
                    border: 'none',
                    background: statusFilter === t ? '#2563eb' : 'transparent',
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center', paddingTop: '2px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select
                ...
                className="premium-input"
                style={{ padding: '6px 12px', borderRadius: '10px', fontSize: '0.82rem', width: 'auto', minWidth: '160px' }}
              >
        ...
        {loading ? (
          <div style={{ padding: '60px', textAlign: 'center', color: '#2563eb' }}>
            ...
            <span style={{ fontSize: '0.88rem', fontWeight: '600', color: '#64748b' }}>Loading marriage cases...</span>
            ...
            <table className="premium-table" style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  ...
                  <th style={{ padding: '14px 16px', textAlign: 'left', fontSize: '0.72rem', fontWeight: '800', color: '#64748b', letterSpacing: '0.05em', textTransform: 'uppercase' }}>Event Date</th>
                  <th style={{ padding: '14px 16px', textAlign: 'left', fontSize: '0.72rem', fontWeight: '800', color: '#64748b', letterSpacing: '0.05em', textTransform: 'uppercase' }}>Documents</th>
                  ...
                  return (
                    <tr key={item.id !== undefined && item.id !== null ? `${item.id}-${index}` : index}>
                      ...
                      <td style={{ padding: '14px 16px', fontSize: '0.8rem' }}>
                        {cardUrl ? (
                          <a href={cardUrl} target="_blank" rel="noopener noreferrer" style={{ color: '#0284c7', fontWeight: '700', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '4px', background: '#f0f9ff', padding: '4px 10px', borderRadius: '8px', border: '1px solid #bae6fd' }}>
                            <Download size={13} /> View Card
                          </a>
                        ) : (
        ...
        {!loading && filteredList.length === 0 && (
          <div style={{ textAlign: 'center', padding: '60px 16px', color: '#64748b' }}>
            ...
            <div style={{ fontWeight: '800', fontSize: '0.95rem', color: '#0f172a' }}>No Marriage Records Found</div>
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
          ...
          <div className="card" style={{ position: 'relative', background: '#fff', borderRadius: '20px', padding: '28px', maxWidth: '460px', width: '100%', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }}>
            ...
            <form onSubmit={handleConfirmSettlement} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: '700', color: '#334155', marginBottom: '6px' }}>Marriage Event Photo</label>
      ...
      {deleteId && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
          ...
          <div className="card" style={{ position: 'relative', background: '#fff', borderRadius: '20px', padding: '28px', maxWidth: '400px', width: '100%', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }}>
            ...
            <div style={{ fontWeight: '800', fontSize: '1.15rem', color: '#0f172a', textAlign: 'center', marginBottom: '8px' }}>Delete Marriage Event</div>
